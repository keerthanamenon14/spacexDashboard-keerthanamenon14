      ...
      <Grid container>
        <Grid item className={classes.missionImageBlock}>
          {rowData.links.mission_patch_small && (
            <img
              src={rowData.links.mission_patch_small}
              alt="image"
        ...
        <Grid item>
          <Grid
            container
            direction="column"
            className={classes.missionDetailsContainer}
          >
            <Grid item>
              <Typography style={{ fontSize: "20px", lineHeight: "1.5" }}>
            ...
            <Grid container>
              <Grid item>
                <img
                  ...
                  src={nasa}
                  onClick={() =>
                    window.open(rowData.links.article_link, "_blank")
                  }
                ></img>
              </Grid>
              <Grid item>
                {rowData.links.wikipedia && (
                  <img
                    ...
                    src={wikipedia}
                    onClick={() =>
                      window.open(rowData.links.wikipedia, "_blank")
                    }
                  ></img>
                )}
              </Grid>
              <Grid item>
                {rowData.links.video_link && (
                  <YouTubeIcon
                    onClick={() =>
                      window.open(rowData.links.video_link, "_blank")
                    }
                    className={classes.imageStyle}
                  />
                )}
